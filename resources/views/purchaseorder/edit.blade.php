...
<head>
  ...
  <title>Ubah Purchase Order - PT. Kobar Indonesia</title>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Halaman Ubah Data Purchase Order PT. Kobar Indonesia
                  </p>
                  ...
                  <form class="forms-sample" method="POST" action="{{ route('po.update', $po->nopo) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nopo" name="nopo" 
                             value="{{ $po->nopo }}" placeholder="No. PO" readonly disabled>
                    </div>
                    
                    <div class="form-group">
                        <label for="idcustomer">Customer</label>
                        <input type="text" class="form-control" id="idcustomer_display" 
                            value="{{ $po->customer->namacustomer ?? '' }}" readonly>
                        <input type="hidden" name="idcustomer" value="{{ $po->idcustomer }}">
                        <small class="form-text text-muted small" style="font-size: 0.7rem;">
                            Customer tidak dapat diubah setelah PO dibuat
                        </small>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tglpo') is-invalid @enderror" 
                                id="tglpo" name="tglpo" 
                                value="{{ old('tglpo', date('Y-m-d', strtotime($po->tglpo))) }}" 
                                required>
                            @error('tglpo')
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="month" class="form-control @error('deliveryschedule') is-invalid @enderror" 
                                 ...
                                 value="{{ old('deliveryschedule', date('Y-m', strtotime($po->deliveryschedule))) }}" 
                                 required>
