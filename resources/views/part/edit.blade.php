...
<body>
  ...
  <ul class="nav">
    ...
    <li class="nav-item active" id="part-menu">
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Form Part </h4>
                  <p class="card-description">
                    Halaman Ubah Data Part PT. Kobar Indonesia
                  </p>
                  ...
                  <form class="forms-sample" method="POST" action="{{ route('part.update', $part->nopart) }}">
                    @csrf
                      @method('PUT') 
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="namapart" name="namapart" 
                            value="{{ old('namapart', $part->namapart) }}" 
                            placeholder="Nama Part" required>
                    </div>
                    <div class="form-group">
                      <label for="harga">Harga</label>
                      <input type="text" class="form-control" id="harga" name="harga" 
                            value="{{ number_format($part->harga, 0, ',', '.') }}" 
