...
<head>
  ...
  <title>Tambah Kendaraan - PT. Kobar Indonesia</title>
  <!-- plugins:css -->
...
<body>
                  ...
                  <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                      ...
                      <p class="card-description mb-0">
                        Halaman Tambah Data Kendaraan PT. Kobar Indonesia
                      </p>
                    </div>
                    </a>
                  </div>
                  ...
                  <form method="POST" action="{{ route('kendaraan.store') }}">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="mb-3">
                          <label for="namakendaraan" class="form-label">Nama Kendaraan <span class="text-danger">*</span></label>
                          <input type="text" class="form-control @error('namakendaraan') is-invalid @enderror" 
                                 id="namakendaraan" name="namakendaraan" 
                                 value="{{ old('namakendaraan') }}" 
                                 placeholder="Contoh: Truk Mitsubishi Fuso" required>
                          @error('namakendaraan')
                              <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
  ...
  <script>
  // Cek pathname dan tambahkan class active jika mengandung 'kendaraan'
  if (window.location.pathname.includes('kendaraan')) {
      if (document.getElementById('kendaraan-menu')) {
          document.getElementById('kendaraan-menu').classList.add('active');
      }
  }
  </script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
      ...
      form.addEventListener('submit', function(e) {
          ...
          const namakendaraan = document.getElementById('namakendaraan').value.trim();
          ...
          if (!namakendaraan) {
              ...
              document.getElementById('namakendaraan').focus();
              return false;
          }
      });
  });
