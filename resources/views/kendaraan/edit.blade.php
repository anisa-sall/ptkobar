...
<head>
  ...
  <title>Edit Kendaraan - PT. Kobar Indonesia</title>
  <!-- plugins:css -->
            ...
            <div class="col-sm-12">
              <div class="card">
                <div class="card-body">                 
                  ...
                  <form action="{{ route('kendaraan.update', $kendaraan->nopol) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" 
                                 class="form-control @error('namakendaraan') is-invalid @enderror" 
                                 id="namakendaraan" 
                                 name="namakendaraan" 
                                 value="{{ old('namakendaraan', $kendaraan->namakendaraan) }}"
                    ...
                    <div class="mt-4">
                      ...
                      <a href="{{ route('kendaraan.index') }}" class="btn btn-light">
                        Cancel
                      </a>
                    </div>
                  </form>
