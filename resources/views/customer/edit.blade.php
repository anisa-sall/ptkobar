...
<head>
  ...
  <title>Edit Customer - PT. Kobar Indonesia</title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper"> 
      <nav class="sidebar sidebar-offcanvas sidebar-dark" id="sidebar">
        <ul class="nav">
          ...
          @php
            // Definisikan fungsi hasAccess dan variabel
            function hasAccess($menuName, $departemen, $menuAccess = null) {
              if (is_null($menuAccess)) {
                $menuAccess = [
            ...
            $departemen = $departemen ?? session('departemen', '');
          @endphp
          
          @if(hasAccess('customer', $departemen))
          ...
          @if(hasAccess('petugas', $departemen))
          <li class="nav-item">
            <a class="nav-link" href="#">
          ...
          @if(hasAccess('kendaraan', $departemen))
          <li class="nav-item">
          ...
          @if(hasAccess('suratjalan', $departemen))
          <li class="nav-item">
            <a class="nav-link" href="#">
                  ...
                  <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                      ...
                      <p class="card-description mb-0">
                        Form pengeditan data customer PT. Kobar Indonesia
                      </p>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="namacustomer" class="form-label">Nama Customer</span></label>
                          <input type="text"
                                 name="namacustomer"
                                 id="namacustomer"
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="alamat" class="form-label">Alamat</span></label>
                          <textarea name="alamat"
                                    ...
                                    required
                                    style="resize: vertical; min-height: 80px;">{{ old('alamat', $customer->alamat) }}</textarea>
                          @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
