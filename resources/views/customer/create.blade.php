...
<body>
  <div class="container-scroller">
                  ...
                  <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                      ...
                      <p class="card-description mb-0">
                        Halaman Tambah Data Customer PT. Kobar Indonesia
                      </p>
                    </div>
    ...
    <div class="mb-4">
        ...
        <textarea name="alamat" rows="6" class="form-control" style="height:150px;" required></textarea>
    </div>

    <!-- ACTION BUTTONS -->
    <div style="display: flex; gap: 12px; justify-content: flex-start; margin-top: 30px;">
  ...
  if (window.location.pathname.includes('customer')) {
      const customerMenu = document.querySelector('a[href*="customer"]');
      if (customerMenu) {
          customerMenu.parentElement.classList.add('active');
      }
  }
  </script>
  ...
  // Form validation untuk customer
  document.addEventListener('DOMContentLoaded', function() {
      const form = document.querySelector('form');
      
      form.addEventListener('submit', function(e) {
          const namaCustomer = document.querySelector('[name="nama_customer"]').value.trim();
          const alamat = document.querySelector('[name="alamat"]').value.trim();
          
          if (!namaCustomer) {
              e.preventDefault();
              alert('Nama Customer harus diisi');
              document.querySelector('[name="nama_customer"]').focus();
              return false;
          }
          ...
          if (!alamat) {
              ...
              document.querySelector('[name="alamat"]').focus();
              return false;
          }
      });
  });
